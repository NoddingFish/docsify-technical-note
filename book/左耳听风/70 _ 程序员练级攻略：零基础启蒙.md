...
<p>这里主要推荐时下最流行也是最好用的Visual Studio Code，这个工具潜力十足，用它开发Python、JavaScript、Java、Go、C/C++都能得心应手（<a href="https://www.gitbook.com/book/jeasonstudio/vscode-cn-doc/details">教程</a> - 本文发布时还基本没怎么翻译完）。</p>
<h2>Web编程入门</h2>
